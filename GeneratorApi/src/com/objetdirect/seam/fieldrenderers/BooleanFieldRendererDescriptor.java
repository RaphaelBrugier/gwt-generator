...
public class BooleanFieldRendererDescriptor extends FieldRendererDescriptor {

	public BooleanFieldRendererDescriptor(
		String fieldName, 
		String fieldPath, 
		String fieldTitle) 
	{
	...
	public FragmentDescriptor buildFragment() {
		...
		FragmentDescriptor fragment = new FragmentDescriptor(
			"<h:selectBooleanCheckbox value=\"#{entity.field}\"/>");
		if (getFieldName()!=null)
	...
	public String getCriterion() {	
		String criterion = "new Criterion(\"criterionLabel\", \"criterionLabel : \", \"boolean\")";
