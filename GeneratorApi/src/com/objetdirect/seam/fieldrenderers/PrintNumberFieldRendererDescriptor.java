...
public class PrintNumberFieldRendererDescriptor extends FieldRendererDescriptor {

	String pattern;
	int length;
	
	public PrintNumberFieldRendererDescriptor(
		String fieldName, 
		String fieldPath, 
		String fieldTitle, 
		String pattern,
	...
	public PrintNumberFieldRendererDescriptor setPdfFlag(boolean pdfFlag) {
	...
	public FragmentDescriptor buildFragment() {
		...
		fragment.replace("numberPattern", pattern);
		return fragment;
	}
