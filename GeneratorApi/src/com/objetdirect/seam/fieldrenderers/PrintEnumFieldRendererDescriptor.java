...
public class PrintEnumFieldRendererDescriptor extends FieldRendererDescriptor {

	public PrintEnumFieldRendererDescriptor(
		String fieldName, 
		String fieldPath, 
		String fieldTitle,
		int length) 
	...
	public PrintEnumFieldRendererDescriptor setPdfFlag(boolean pdfFlag) {
	...
	public FragmentDescriptor buildFragment() {
		...
		FragmentDescriptor fragment = new FragmentDescriptor(
			"<h:outputText value=\"#{entity.field.label}\"/>"
		);
		if (pdfFlag)
