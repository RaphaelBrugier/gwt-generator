...
public class InterfaceDescriptor extends BasicInterfaceDescriptor {
	...
	static final String[] defaultPattern = {
		...
		"",
		"/// annotations here",
		"public interface InterfaceName extends Interface {",
		"	/// constants here",
		"",
		"	/// methods here",
		"}"
	...
	public InterfaceDescriptor(String packageName, NameMaker nameMaker, String ... pattern) {
	...
	public InterfaceDescriptor(String packageName, String name, String ... pattern) {
	...
	public InterfaceDescriptor addInterface(TypeDescriptor interfaceType) {
		super.addInterface(interfaceType);
		return this;
	}

	public InterfaceDescriptor addAnnotation(TypeDescriptor type, String ... params) {
		super.addAnnotation(type, params);
		return this;
	}
	
	public InterfaceDescriptor addAnnotationParam(TypeDescriptor type, String param) {
		super.addAnnotationParam(type, param);
		return this;
	}
	
	public InterfaceDescriptor replace(String replaceThis, TypeDescriptor byThis) {
		super.replace(replaceThis, byThis);
		return this;
	}

	public InterfaceDescriptor replace(String ... replacements) {
