 ...
 */
public class TestNumberFieldProcessor extends TestProcessor {
	...
	@Test
	public void process() {
		NumberFieldProcessor pdp = new NumberFieldProcessor(seamGenerator);
		...
		NumberField numberFieldExpected = new NumberField(FIELD_NAME_VALUE, FIELD_TITLE_VALUE, PATTERN_VALUE, LENGTH_VALUE);
		pdp.process(objectArgument);
		
		verify(seamGenerator).addBridgeObject(eq(objectArgument), eq(numberFieldExpected));
	}
}
