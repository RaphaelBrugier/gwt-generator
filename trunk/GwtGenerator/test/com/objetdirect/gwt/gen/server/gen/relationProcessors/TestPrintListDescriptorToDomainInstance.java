 ...
 */
public class TestPrintListDescriptorToDomainInstance extends TestRelationProcessor {
	...
	@Test
	public void process() {
		PrintEntityToDomainInstance processor = new PrintEntityToDomainInstance(seamGenerator);
		setReturnedGenObject(printEntityDescriptor, entity, "entity");
		...
		verify(printEntityDescriptor).setEntity(entity);
	}
}
