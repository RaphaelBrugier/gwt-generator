 ...
 */
public class HasFieldsToNumberField extends RelationProcessor<HasFields, NumberField> {

	public HasFieldsToNumberField(SeamGenerator seamGenerator) {
		super(seamGenerator);
	}
	...
	public List<String> getTargetClassNames() {
		...
		return Arrays.asList(NUMBER_FIELD);
	}
}
