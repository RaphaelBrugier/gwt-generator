...
public class PersistentSelectManyListDescriptor	
	...
	public PersistentSelectManyListDescriptor(String relationshipName) {
	...
	public void buildFaceletPart() {
		...
		if (getNavigationPopup()!=null)
			getNavigationPopup().buildFaceletPart();
	}
	...
	public PersistentSelectManyListDescriptor showField(
		String fieldName,
		String fieldTitle, 
		int length) 
	{
	...
	public PersistentSelectManyListDescriptor showNumberField(String fieldName, String fieldTitle, String pattern, int length) {
		super.showNumberField(fieldName, fieldTitle, pattern, length);
		return this;
	}

	public PersistentSelectManyListDescriptor showDateField(String fieldName, String fieldTitle, String pattern) {
		super.showDateField(fieldName, fieldTitle, pattern);
		return this;
	}

	public PersistentSelectManyListDescriptor showBooleanField(String fieldName, String fieldTitle, String trueValue, String falseValue) {
		super.showBooleanField(fieldName, fieldTitle, trueValue, falseValue);
		return this;
	}

	public PersistentSelectManyListDescriptor showEnumField(String fieldName, String fieldTitle, int length) {
		super.showEnumField(fieldName, fieldTitle, length);
		return this;
	}

	public PersistentSelectManyListDescriptor showEntityField(String fieldName, String fieldTitle, String labels, int length) {
		super.showEntityField(fieldName, fieldTitle, labels, length);
		return this;
	}
	
	public PersistentSelectManyListDescriptor addDelete(String deleteMessage) {
	...
	protected MethodDescriptor buildListGetterMethod() {
		...
		meth.setContent(
			"if (entityList!=currentEntity.getChildren()) {",
			"	entityList = currentEntity.getChildren();",
	...
	public PersistentSelectManyListDescriptor setSelectionCaller(MultipleSelectionCallerDescriptor selectionCaller) {
