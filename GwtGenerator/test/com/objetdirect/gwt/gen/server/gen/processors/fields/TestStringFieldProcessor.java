...
public class TestStringFieldProcessor extends TestProcessor {
	...
	public void process() {
		...
		StringField stringFieldExpected = new StringField(FIELD_NAME_VALUE, FIELD_TITLE_VALUE, LENGTH_VALUE);
		
		pdp.process(objectArgument);
		
		verify(seamGenerator).addBridgeObject(eq(objectArgument), eq(stringFieldExpected));
	}
}
